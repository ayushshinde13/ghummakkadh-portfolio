                ...
                <tr key={row.id} className="hover:bg-[var(--admin-border)] transition-colors group">
                  ...
                  <td className="px-4 py-4 text-right">
                    <button 
                      ...
                      className="inline-flex items-center justify-center gap-1.5 h-8 px-3 rounded-md bg-[var(--admin-border)] border border-[var(--admin-border)] hover:bg-[var(--admin-border)] text-[var(--admin-text)] text-xs font-medium transition-colors"
                    >
                      <MapPin size={14} className="text-[var(--admin-muted)]" />
                      View Map
                    </button>
                  </td>
                </tr>
          ...
          <div className="w-full max-w-4xl bg-[var(--admin-background)] border border-[var(--admin-border)] rounded-2xl shadow-2xl overflow-hidden flex flex-col h-[80vh]">
            ...
            <div className="h-16 border-b border-[var(--admin-border)] flex items-center justify-between px-6 bg-[var(--admin-border)] shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-[var(--admin-text)] font-bold tracking-tight">Live Trip Map</h3>
                  <p className="text-xs text-[var(--admin-muted)]">Tracking Trip ID: {selectedMapTrip}</p>
                </div>
              </div>
              <button 
