  ...
  return (
    <section id="how-it-works" className="bg-[#FEFCE8] pt-6 pb-16 md:pt-10 md:pb-24 overflow-hidden">
      <Container className="max-w-[1400px] mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {steps.map((step) => (
              <div key={step.num} className="relative">
                ...
                {/* Card Container */}
                <div className="bg-white rounded-[28px] p-6 border-2 border-transparent hover:border-[#FBBF24] hover:shadow-[0_20px_55px_rgba(251,191,36,0.2)] hover:-translate-y-1 hover:z-10 transition-all duration-300 flex flex-col items-center justify-start h-full shadow-[0_4px_20px_rgba(0,0,0,0.02)] pt-12 relative">
        ...
        {/* CTA Banner */}
        <div className="bg-[#F5FFF0] rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 mb-8 max-w-6xl mx-auto border border-[#E0FFCC]/50 shadow-sm">
          <div className="flex items-center gap-6 z-10 relative">
            ...
            <div>
              ...
              <p className="text-gray-600 font-medium text-[13px] md:text-sm">Ghumakkadh ke saath har safar easy, safe aur affordable.</p>
            </div>
          </div>
