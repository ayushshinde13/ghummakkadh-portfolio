  ...
  return (
    <section className="bg-slate-50 dark:bg-gradient-to-b dark:from-[#0A0E1A] dark:to-[#0D1220] text-slate-900 dark:text-white pt-24 md:pt-8 pb-24 overflow-hidden relative transition-colors duration-300" id="support-features">
      <Container className="max-w-[1440px] mx-auto px-4 md:px-8">
        ...
        <div className="w-full bg-white dark:bg-white/5 backdrop-blur-md border border-slate-200 dark:border-white/10 rounded-[32px] p-8 md:p-12 shadow-sm dark:shadow-[0_15px_40px_rgba(0,0,0,0.2)] mb-16 max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2">Still need help? Send us a message</h3>
            <p className="text-slate-600 dark:text-gray-400 font-medium">Fill out the form below and our dedicated support team will get back to you shortly.</p>
          </div>

          <form className="flex flex-col gap-5">
            <div className="flex flex-col sm:flex-row gap-5">
              <div className="flex-1">
                <label className="block text-slate-900 dark:text-white font-bold text-sm mb-2">Full Name</label>
                <input type="text" placeholder="John Doe" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#4eb902] focus:ring-1 focus:ring-[#4eb902] transition-colors" />
              </div>
              <div className="flex-1">
                <label className="block text-slate-900 dark:text-white font-bold text-sm mb-2">Email Address</label>
                <input type="email" placeholder="john@example.com" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#4eb902] focus:ring-1 focus:ring-[#4eb902] transition-colors" />
              </div>
            </div>

            <div>
              <label className="block text-slate-900 dark:text-white font-bold text-sm mb-2">Subject</label>
              <select defaultValue="" className="w-full bg-slate-50 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#4eb902] focus:ring-1 focus:ring-[#4eb902] transition-colors appearance-none">
                <option value="" disabled className="text-slate-400 dark:text-gray-400">Select a topic</option>
                <option value="ride" className="text-slate-900 dark:text-gray-900">Ride Issue</option>
                <option value="drive" className="text-slate-900 dark:text-gray-900">Driver Onboarding</option>
                <option value="parcel" className="text-slate-900 dark:text-gray-900">Parcel Delivery</option>
                <option value="payment" className="text-slate-900 dark:text-gray-900">Payment & Billing</option>
                <option value="other" className="text-slate-900 dark:text-gray-900">Other</option>
              </select>
            </div>

            <div>
              <label className="block text-slate-900 dark:text-white font-bold text-sm mb-2">Message</label>
              <textarea placeholder="How can we help you?" rows={4} className="w-full bg-slate-50 dark:bg-white/5 border border-slate-300 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#4eb902] focus:ring-1 focus:ring-[#4eb902] transition-colors resize-none"></textarea>
            </div>

            <button type="button" className="bg-[#4eb902] hover:bg-[#3d9400] text-slate-950 font-bold py-3.5 px-8 rounded-xl transition-colors mt-2 self-start shadow-sm">
              Send Message
            </button>
          </form>
        </div>
