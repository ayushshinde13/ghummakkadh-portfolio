...
async function extractOrange() {
  ...
  image.scan(0, 0, image.bitmap.width, image.bitmap.height, function (x, y, idx) {
    ...
    if (alpha > 128) { // Skip transparent
        // Look for orange (High Red, Medium Green, Low Blue)
        if (red > 150 && green < 180 && blue < 100 && red > green) {
